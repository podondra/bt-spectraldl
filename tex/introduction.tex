...
Astronomy and science in general are being transformed by exponential growth
...
Therefore, deep networks should help to make new discoveries in astronomy.

The goal of this work is to identify emission-line spectra
in the \glref{LAMOST} spectral survey archive using deep neural networks
...
its training and classification results of spectra from LAMOST.
