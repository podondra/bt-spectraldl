...
\abstractCZ  {TODO}
\keywordsEN  {
    TODO, deep learning, convulutional neural networks, astroinformatics,
    astronomy, Virtual Observatory, GPGPU, CUDA, Python
}
\keywordsCZ  {
    TODO, hluboké učení, konvoluční neuronové sítě, astroinformatika,
    astronomie, Virtuální Observatoř, GPGPU, CUDA, Python
}
