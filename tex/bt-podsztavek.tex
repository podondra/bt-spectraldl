...
\abstractEN  {
    ...
    Deep learning is one of the most popular method used nowadays
    to gain knowledge from this kind of data.
    This work shows the process of finding emission-line spectra in
    \glref{LAMOST} archive using deep convolutionl neural network trained
...
\abstractCZ  {
    ...
    obsahují spoustu skrytých informací.
    ...
    \glref{LAMOST} za použití hluboké konvoluční neuronové sítě natrénovaní
    ...
    redukce dimensionality, návrh a trénování dvou neuronových síťí.
    Nakonci práce je dikuze objevených objektů se zajímavou fyzikální podstatou,
    které vyžadujů další detailní analýzu.
}
\keywordsEN  {
