...
Aim of this chapter is to describe this kind of data.
...
The electromagnetic wave is described in terms of frequency
or wavelength:
...
or astronomy usually uses {\AA}ngströms (1\,{\AA}~=~10$^{-10}$\,m).
...
energy depends on its temperature (see figure~\ref[black-body]).
...
\caption/f Black body radiation curves of 3\,000, 4\,000 and 5\,000 Kelvins hot
stars.
\endinsert
...
(see figure~\ref[continuum-normalization]).
A smooth curve is fit to the continuum and then the spectrum is divided by it.
This sets the continuum everywhere to value 1 and allows to measure spectral
...
On a graph of wavelengths fluxes emission
...
observed features in spectroscopy. \cite[cosmos]

H$\alpha$ is deep-red visible spectral line.
Its wavelength in air is 6\,562.8\,{\AA} and in vacuum is 6\,564.6\,{\AA}.
...
Be stars are {\bf non-supergiant B stars}\fnote{Stars from spectral type B are
hydrogen burning stars which have 2 to 16 times the mass of the Sun
and surface temperatures between 10\,000 and 30\,000 K. \cite[habets1981]}
with spectrum that has or had
one or more {\bf Balmer lines in emission at some time}.
Although this definition is not precise it is sufficient for purpose of this
work. \cite[porter2003]

It is believed that a Be star consists of fast rotating star
...
It currently contains about 17\,000 spectra \cite[voarchive].
Because this archive is {\bf specialized on Be stars observations}
it contains approximately 13\,000 spectra with H$\alpha$ spectral line.
...
The spectrograph's spectral resolving power is about 13\,000 in H$\alpha$
\cite[stelweb].
...
is telescope located in China with spectral resolving power 500, 1\,000
or 1\,500.
...
\midinsert \clabel[lamost-table]{LAMOST data releases}
\ctable{lrr}{
    \hfil survey & total spectra \hfil & stars \hfil \crl \tskip4pt
    pilot        & 958\,944            & 812\,911    \cr
    first year   & 1\,701\,669         & 1\,529\,958 \cr
    second year  & 1\,648\,485         & 1\,501\,002 \cr
    third year   & 1\,659\,028         & 1\,511\,032 \cr
    forth year   & 1\,713\,059         & 1\,543\,415 \crl \tskip4pt
    \hfil total  & 7\,681\,185         & 6\,898\,318 \cr
}
...
data files. It is designed to store datasets consisting of
multidimensional arrays and two dimensional tables. \cite[fits-support-office]

A \glref{FITS} file is comprised of segments called Header/Data
Units (\glref{HDU}s).
...
a {\bf 1 dimensional spectrum}, a 2 dimensional image,
