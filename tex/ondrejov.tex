...
of spetral dataset from Ondřejov CCD700 archive.
...
There are 45.8\% spectra with absoption line ins H$\alpha$
and 39.7\% with emission line.
But there are also 11.5\% spectra with double-peak in H$\alpha$
plus 3.0\% spectra which cannot be easily classified.
